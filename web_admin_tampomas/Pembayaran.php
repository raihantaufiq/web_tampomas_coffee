...
<html>
    ...
    <body classname='snippet-body' class="body-pd">
        <body id="body-pd">
                ...
                <nav class="nav">
                    <div>
                        ...
                        <div class="nav_list">
                            ...
                            <a href="Pembayaran.php" class="nav_link active">
            ...
            <div class="py-3">
                <h3 class="text-center pb-3 ">Pembayaran</h3>
                <div class="card p-2">
                      ...
                      <table class="table table-striped table-hover">
                        <thead >
                          ...
                          <tbody>
                            ...
                            include("proses/db_connect.php");
                            // ambil isi bungkus (pemesanan)
                            $query = "SELECT id_bungkus, status_pemesanan, tanggal_pemesanan FROM m_pemesanan WHERE status_pemesanan=0 OR status_pemesanan=1 GROUP BY id_bungkus ORDER BY status_pemesanan DESC";
                            $result = mysqli_query($db_connect, $query);
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <?php 
                                    if ($row_pemesanan['status_pemesanan'] == 1) { ?>
                                        <!-- sudah bayar -->
                                        <td><span class="rounded-category-green" style="color:white;">Sudah Bayar</span></td>
                                        <!-- nanti ambil gambat dari payment verif -->
                                        <td><a href="detail_bukti_bayar.php?id_bungkus=<?= $id_bungkus ?>">Detail</a></td>
                                        <td><a href="shipping_admin.php?no_order=<?= $id_bungkus ?>">Kirim</a> / <a href="proses/masuk_fraud.php?no_order=<?= $id_bungkus ?>">Batal</a></td>
                                    <?php }else if ($row_pemesanan['status_pemesanan'] == 0){ ?>
                                        <!-- belum bayar -->
                                        <td><span class="rounded-category-yellow" style="color:white;">Belum Bayar</span></td>
                                        <td></td>
                                        <td><a class="text-muted">Kirim</a> / <a href="proses/masuk_fraud.php?no_order=<?= $id_bungkus ?>">Batal</a></td>
                                    <?php } ?>
                                </tr>
                                <!-- end while -->
                            <?php } ?>

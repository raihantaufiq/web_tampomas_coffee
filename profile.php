              ...
              <div class="container py-5 my-5">
                <div class="align-items-center g-0 row ">
                    <div class="py-5 py-lg-0">
                      <h5 class="text-white fw-semi-bold" style="font-family: 'Public Sans'; font-size: 72px; letter-spacing: -3px;">Profil</h5>
                    </div>
                </div>
              </div>
            </div>
          ...
          <div class="row d-flex justify-content-center">
              <!-- <div class="p-5 d-flex justify-content-center">
                <div class="profile_img">
                  <img src="assets/image/person-dummy.jpg" alt="">
                </div>
              </div> -->
              <?php
              ...
              ?>
              <h4  class="d-flex justify-content-center pb-5">Hallo, <?php echo $nama; ?>!</h4>
              <div class="about">
                  <form action="proses/update_profile_p.php" method="post" class="mt-4" enctype="multipart/form-data">
                      <div class="mb-3">
                        <div class="row">
                          <!-- id customer pada form -->
                          <?php
                          echo '<input type="hidden" id="id_m_customer" name="id_m_customer" value="'.$id_customer.'">';
                          ?>
                          <div class="col">
                          ...
                          <div class="col">
                            ...
                            <input type="text" class="form-control" id="inputKelurahan" name="inputKelurahan" value="<?php echo $kelurahan; ?>">
                          </div>
                        </div>
                      </div>
                      <div class="mb-3">
                        <div class="row">
                          <div class="col">
                            ...
                            <input type="text" class="form-control" id="inputNoHp" name="inputNoHp" value="<?php echo $telepon; ?>">
                          </div>
                          <div class="col">
                            <label for="inputKecamatan" class="form-label">Kecamatan</label>
                            <input type="text" class="form-control" id="inputKecamatan" name="inputKecamatan" value="<?php echo $kecamatan; ?>">
                          </div>
                        </div>
                      </div>
                      <div class="mb-3">
                        <div class="row">
                          ...
                          <div class="col">
                            ...
                            <input type="text" class="form-control" id="inputKota" name="inputKota" value="<?php echo $kota; ?>">
                          </div>
                        </div>
                      </div>
                      <div class="mb-3">
                        <div class="row">
                          <div class="col">
                            ...
                            <input type="text" class="form-control" id="inputAlamat" name="inputAlamat" value="<?php echo $alamat; ?>">
                          </div>
                          <div class="col">
                            <label for="inputKodepos" class="form-label">Kode Pos</label>
                            <input type="text" class="form-control" id="inputKodepos" name="inputKodepos" value="<?php echo $zipcode; ?>">
                          </div>
                        </div>
                      </div>
                      <div class="mb-3">
                        <label for="inputProvinsi" class="form-label">Provinsi</label>
                        <select id="inputProvinsi" name="inputProvinsi" class="form-select">
                      ...
                      <div class="d-flex justify-content-end">
                          <input type="submit" name="submit_profile" id="submit_profile" class="btn btn-success d-flex me-3" value="Simpan">
                          <input type="reset" class="btn btn-outline-success d-flex" value="Batal">
                      </div>

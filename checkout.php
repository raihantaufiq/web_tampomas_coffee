        ...
        <div class="bg-white">
            <div class="pt-5 text-center rounded text-white">
              <div class="container  mb-5">
                <div class="g-0 row">
                    <div class="py-lg-0">
                        <h1 class="secondary full-typeface text-center" style=" font-size: 48px; letter-spacing: -3px; font-weight: 500;">Pengiriman Pesanan</h1>
          ...
          <div class="container px-0 px-lg-3 mb-5">
            <nav>
              ...
              <?php if(isset($_GET['produk']) && isset($_GET['jml'])){ ?>
                  ...
                  <li class="breadcrumb-item primary" style="font-size: 18px;">Pengiriman</li>
                <?php } else { ?>
                  <li class="breadcrumb-item "><a href="cart.php" style="font-size: 18px; text-decoration: none; color:black">Keranjang</a></li>
                  <li class="breadcrumb-item primary" style="font-size: 18px;">Pengiriman</li>
                <?php } ?>
                <li class="breadcrumb-item active" style="font-size: 18px;">Pembayaran</li>
              </ol>
            </nav>
            <?php 
            ...
            <div class="row justify-content-between mt-5">
              <div class="col-5">
                ...
                if (isset($_GET['produk']) && isset($_GET['jml'])) {
                  ...
                  $jml = $_GET['jml'];
                  $action_form = "payment.php?produk=$id_produk&jml=$jml";
                }else {
                  // untuk pemesanan dari chart
                  $action_form = "payment.php";
                }
                ?>

                <form action="<?php echo $action_form; ?>" method="POST">
                  <div class="form-floating mb-2">
                    <input name="Nama" type="text" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?php echo $nama?>" required>
                    <label for="floatingInput">Nama</label>
                  </div>
                  <div class="form-floating mb-2">
                    <input name="Contact" type="Contact" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?php echo $telepon?>" required>
                    <label for="floatingInput">Kontak</label>
                  </div>
                  <div class="form-floating mb-3">
                    <textarea name="alamat" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px; resize: none;"><?php echo "".$alamat .", ". $kelurahan .", ". $kota .", ". $provinsi .", ". $zipcode ?></textarea>
                    <label for="floatingTextarea2">Kirim Ke</label>
                  </div>
      
                  <div class="d-grid gap-2 mt-5 d-md-flex justify-content-md-start">
                    <input class="btn btn-success btn-login px-4" name="submit_from_checkout" type="submit" value="Lanjutkan Pembayaran">
                  </div>
                </form>
              </div>
